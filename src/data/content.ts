...
export const painPoints = [
  'Всё держите на себе и устали постоянно быть сильным.',
  'Вам сложно говорить о своих чувствах и быть услышанным.',
  'В отношениях с женой накопилось напряжение.',
  'Вам хочется больше близости и уважения в отношениях с детьми.',
  'В работе многое получается, а в личной жизни — нет.',
  'Есть ощущение, что Вы потеряли направление.',
  'Хочется понять, каким мужчиной Вы хотите быть на самом деле.',
  'Есть деньги, статус или семья, но внутри нет удовлетворения.'
]

export const audiencePoints = [
  'Вы — муж и хотите улучшить отношения с женой.',
  'Вы — отец и хотите быть ближе к детям.',
  'Вы — руководитель и устали постоянно всё контролировать.',
  'Вы находитесь в периоде перемен.',
  'Вы достигли многого, но потеряли внутреннюю опору.',
  'Вы хотите понять, что значит быть мужчиной в современном мире.'
]
...
export const courseResults: ResultCard[] = [
  ...
  },
  {
    ...
    text: 'Понимать, куда Вы идёте и ради чего.'
  },
  {
    title: 'Быть опорой',
