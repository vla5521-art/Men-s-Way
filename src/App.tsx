      ...
      <main id="main-content">
        ...
        <section className="finalCta">
          <div className="sectionInner">
            ...
            <h2>Включайтесь в прорывной путь</h2>
            <p>От ограничений и напряжения — к внутренней устойчивости, осмысленной жизни и духовному развитию.</p>
            <a className="btn primary" href="#registration">Записаться на курс</a>
            <span>Старт — 22 сентября 2026 года. Формат — онлайн.</span>
          </div>
        </section>
      </main>
      <footer>
